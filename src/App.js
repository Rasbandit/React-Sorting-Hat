    ...
    return (
      <div className="App">
        <div className="top">
          ...
          <Sorter sortMember={this.sort} />
        </div>
        <div className="houses">
          <House home={this.state.houses[0]} members={this.state.gMembers} />
          <House home={this.state.houses[1]} members={this.state.sMembers} />
          <House home={this.state.houses[2]} members={this.state.hMembers} />
          <House home={this.state.houses[3]} members={this.state.rMembers} />
        </div>
      </div>
    );
  }
